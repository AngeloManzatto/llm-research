"""
Created on Fri Jun 27 07:25:20 2025
...
tokenized_dir = Path("data") / "ntp" / "tokenized" / dataset_id / tokenizer_id
packed_dir    = Path("data") / "ntp" / "packed"   / dataset_id / tokenizer_id
